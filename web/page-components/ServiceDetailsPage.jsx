...
function getLocalGalleryMedia(service) {
  ...
  return [
    { id: 'gym-local-1', url: '/images/gym-1.jpeg', alt_text: 'Nziza Gym room view' },
    { id: 'gym-local-2', url: '/images/gym-2.jpeg', alt_text: 'Nziza Gym training area' },
  ];
}
      ...
      <div className="mx-auto max-w-7xl px-4">
        <ScrollReveal>
          <div className="glass-panel flex flex-col items-start justify-between gap-6 rounded-[2rem] p-8 md:flex-row md:items-center md:p-10">
            ...
            <Link href="/contact" className="btn-primary shrink-0 rounded-full px-8 py-3 text-sm font-semibold">
              Contact concierge
            </Link>
          </div>
        </ScrollReveal>
